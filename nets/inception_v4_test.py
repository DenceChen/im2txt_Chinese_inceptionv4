...
class InceptionTest(tf.test.TestCase):
    ...
    def testBuildLogits(self):
        ...
        logits, end_points = inception_v4(inputs, num_classes)
    ...
    def testBuildWithoutAuxLogits(self):
        ...
        num_classes = 1000
        inputs = tf.random_uniform((batch_size, height, width, 3))
        logits, endpoints = inception_v4(inputs, num_classes, create_aux_logits=False)
    ...
    def testAllEndPointsShapes(self):
        ...
        num_classes = 1000
        inputs = tf.random_uniform((batch_size, height, width, 3))
        _, end_points = inception_v4(inputs, num_classes)
    ...
    def testBuildOnlyUpToFinalEndpoint(self):
        ...
        for index, endpoint in enumerate(all_endpoints):
            with tf.Graph().as_default():
                inputs = tf.random_uniform((batch_size, height, width, 3))
                out_tensor, end_points = inception_v4_base(
    ...
    def testVariablesSetDevice(self):
        ...
        with tf.variable_scope('on_cpu'), tf.device('/cpu:0'):
            inception_v4(inputs, num_classes)
    ...
    def testUnknownBatchSize(self):
        ...
        with self.test_session() as sess:
            ...
            logits, _ = inception_v4(inputs, num_classes)
            self.assertTrue(logits.op.name.startswith('InceptionV4/Logits'))
            self.assertListEqual(logits.get_shape().as_list(),
                                 [None, num_classes])
    ...
    def testEvaluation(self):
        ...
        with self.test_session() as sess:
            ...
            logits, _ = inception_v4(eval_inputs,
                                               num_classes,
                                               is_training=False)
    ...
    def testTrainEvalWithReuse(self):
        ...
        with self.test_session() as sess:
            ...
            inception_v4(train_inputs, num_classes)
