...
tf.flags.DEFINE_string(
    "input_file_pattern",
    "/Users/yangyuxuan/workspace/PyCharm/Inception_v4_Mult_LSTM/data/val-000??-of-00020",
...
tf.flags.DEFINE_string(
    "eval_dir",
    "/Users/yangyuxuan/workspace/PyCharm/Inception_v4_Mult_LSTM/val/",
    "Directory to write event logs.")
tf.flags.DEFINE_integer("eval_interval_secs", 180,
                        "Interval between evaluation runs.")
tf.flags.DEFINE_integer("num_eval_examples", 40000,
